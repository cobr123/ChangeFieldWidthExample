...
public class ChangeFieldWidthExample {

    public static void main(String[] args) {
        new ChangeFieldWidthExample();
    }

    public ChangeFieldWidthExample() {
    ...
    public static class DragProxyPane extends JPanel {
        ...
        private boolean mouseInHotSpot = false;
        ;
        ...
        public DragProxyPane(JComponent comp) {
            MouseAdapter ma = new MouseAdapter() {
                ...
                public void mouseDragged(MouseEvent e) {
                    if (mousePressed && mouseInHotSpot) {
                        final Rectangle bounds = comp.getBounds();
                        final int width = Math.abs((int) bounds.getX() - e.getX());
                        final int height = comp.getHeight(); //Math.abs((int) bounds.getY() - e.getY());
                        comp.setSize(new Dimension(width, height));
                        setSize(new Dimension(width + 21, height + 21));
